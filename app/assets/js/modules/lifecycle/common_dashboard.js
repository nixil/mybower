        ...
        function($, ko, service_dashboard, util) {
            ...
            function CommonDashboardViewModel() {
                ...
                self.beforeRoutingAction = function() {
                    ...
                    console.log("self.serviceInstList " + JSON.stringify(self.serviceInstList));
                    $.ajax({
                        type: 'POST',
...
//                               console.log("service_metrics: " + JSON.stringify(data));
                                self.serviceMetricList = data;
//                                console.log("self.serviceMetricList " + JSON.stringify(self.serviceMetricList));
