define(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'ojs/ojcomponents', 'ojs/ojtable'],
    ...
    function(oj, ko, $) {
        ...
        console.log("defining migrationService2 viewmodel...");
        
        function migrationService2(){
            var self = this;
        ...
        //--------------------Pkg Run Id Drop Down List-------------------------
            self.pkgRunId  = ko.observable('130925_143553');
            //self.pkgRunId('130925_143553');
            //self.pkgRunIds = ko.observableArray(['130925_143553', '130925_135954', '130925_135955', '130925_135956', '130925_135957']);
            ...
            console.log("value of pkgRunId = "+self.pkgRunId());
        //----------------------------------------------------------------------
        ...
        //--------------------Table Transfer Method----------------------------
           ...
           // self.pkgRunId.subscribe(function(data) {
                ...
                $.ajax({
                    async    : true,
                    url      : "js/mock/migration/tableTransferMethod.json",
           ...
           // });
                console.log("The tblTrfMthd is " + self.tblTrfMthd());
        ...
        //---------Migration Job Status (very Large Tables not included)--------
            ...
            self.gridOmigJobStatusVLTNI = { data: self.migJobStatusVLTNI,
                                              ...
                                              columnDefs: [{field: 'job_description', displayName: 'Job Description'},
                                                           ...
                                                           {field: 'pct', displayName: 'Percentage', width: 200, cellTemplate:'<div class="progress progress-striped active" style="margin:5px; background-color:#f0ad4e">' +
        ...
        //--------------Table Migration Status Validation-----------------------
            ...
            self.gOtblMigStatus = {data: self.tblMigStatusVal,
                                   ...
                                   columnDefs: [{field: 'database_name', displayName: 'Database Name'},
                                                ...
                                                {field: 'tables_pct', displayName: '% Completed', width: 200, cellTemplate:'<div class="progress progress-striped active" style="margin:5px; background-color:#f0ad4e">' +
                                                    '<div class="progress-bar" role="progressbar"' +
                                                    'data-bind="attr: {style: \'width:\' + getProperty($parent) + \'%\'}, text: getProperty($parent) + \'%\'"></div></div>'
                                                }]
                                  }; 
        ...
        //----------------------------------------------------------------------
        //----------------End of migrationService2() function--------------------
        };
        
    return new migrationService2();
