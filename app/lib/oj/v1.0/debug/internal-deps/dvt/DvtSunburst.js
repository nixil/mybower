 ...
 * @override
 */
DvtSunburst.prototype.getBundle = function() 
{
  if (!this._bundle)
    this._bundle = new DvtSunburstBundle();
  return this._bundle;
};
/**
 * Sunburst XML Parser
...
DvtSunburstNode.prototype.getAriaLabel = function() {
  ...
  if (this.isExpandCollapseEnabled())
    states.push(this.Bundle.getTranslatedString(this.isDisclosed() ? 'STATE_EXPANDED' : 'STATE_COLLAPSED'));
...
DvtObj.createSubclass(DvtSunburstBundle, DvtUtilBundle, 'DvtSunburstBundle');
...
DvtSunburstBundle.prototype.GetDefaultStringForKey = function(key) {
  var defaultStr = DvtSunburstBundle.superclass.GetDefaultStringForKey.call(this, key);
  return (defaultStr ? defaultStr : DvtSunburstBundle['_defaults'][key]);
};
