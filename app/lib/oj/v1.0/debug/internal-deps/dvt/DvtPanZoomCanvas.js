...
DvtPanZoomComponent.prototype.Render = function() {
  ...
  if (this._endGradientColor || !this.getSkinName()) {
    var backgroundPane = new DvtRect(this.getCtx(), 0, 0, 0, 0);
    this.addChild(backgroundPane);
    backgroundPane.setWidth(this.GetWidth());
    backgroundPane.setHeight(this.GetHeight());
    backgroundPane.setFill(this._getBackgroundGradient(this._endGradientColor));
  }
