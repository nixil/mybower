...
{
    var count, fetchSize, refIndex, queue, prevNodeSetInfo;
...
{
    var refIndex, rangeStart, rowStart, rowCount, parent, depth, metadata, key, toExpand, i, j, queue, prevNodeSetInfo, done;
    ...
    if (done)
    {
        ...
        if ((childCount === -1 && rowCount === this.m_fetchSize) || childCount > rowCount || refIndex == this.m_maxCount)
        {
 ...
 * @private
 */
oj.ArrayRowSet.prototype._endFetch = function(options)
{
