 ...
 */(function ()
{
   ...
   * </h3>
   * 
   * <p>One point that is often overlooked is making the gestures that launch a popup accessible.
   ...
   *   developers should avoid using mouse events to trigger opening of a popup.
   *   This is especially important if the content of the popup can't be derived from other 
   *   visible areas on the page.
   * </p> 
   * 
