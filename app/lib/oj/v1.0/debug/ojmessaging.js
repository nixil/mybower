 ...
 * @type {Object}
 */
oj.ComponentMessage.DISPLAY_TYPE = {IMMEDIATE: 'immediate', DEFERRED: 'deferred'};
...
oj.ComponentMessage._DEFAULT_OPTIONS = {
  'display': oj.ComponentMessage.DISPLAY_TYPE.IMMEDIATE, 
  'context' : ''};
...
oj.ComponentMessage.prototype.canDisplay = function ()
{
  return !(this._options && this._options['display'] ? 
            this._options['display'] === oj.ComponentMessage.DISPLAY_TYPE.DEFERRED : false);
};

/**
 * 
 * Called by framework when the message is forced to display immediately
 * 
 * @returns {boolean} true if immediate; false if deferred 
 * 
 * @memberof! oj.ComponentMessage
 * @instance
 * @private
 */
oj.ComponentMessage.prototype._forceDisplayImmediate = function ()
{
  if (this._options && oj.ComponentMessage.DISPLAY_TYPE.DEFERRED === this._options['display'])
  {
    this._options['display'] = oj.ComponentMessage.DISPLAY_TYPE.IMMEDIATE;
    return true;
  }
