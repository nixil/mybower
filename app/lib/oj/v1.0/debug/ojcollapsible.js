...
//        .removeClass("oj-collapsible-icons")
    ...
    _destroy : function ()
    {
      ...
      this.element
//gab        .removeClass("oj-collapsible oj-component oj-collapsible-collapsed oj-disabled");
...
//gab      this.element.toggleClass("oj-collapsible-collapsed", ! options.expanded);
      if (options.expanded)
      {
        this.element.removeClass("oj-collapsed");
        this.element.addClass("oj-expanded");
      ...
      {
        this.element.removeClass("oj-expanded");
        this.element.addClass("oj-collapsed");
...
//gab            element.addClass("oj-collapsible-collapsed");
...
//gab            element.removeClass("oj-collapsible-collapsed");
