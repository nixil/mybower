...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$22$$, $$$$22$$) {
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$setup$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$setup$$($bInit$$) {
    var $self$$95$$ = this, $cbcClass$$ = $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$;
    if ($bInit$$) {
      ...
      this.$_mouseWheelListener$ = function $this$$_mouseWheelListener$$($event$$239$$) {
        $self$$95$$.$_handleMouseWheel$($event$$239$$);
      };
      ...
      this.$_touchStartListener$ = function $this$$_touchStartListener$$($event$$240$$) {
        $self$$95$$.$_handleTouchStart$($event$$240$$);
      };
      $cbcClass$$.$_addBubbleEventListener$(this.$_overflowContainer$, "touchstart", this.$_touchStartListener$);
      this.$_touchMoveListener$ = function $this$$_touchMoveListener$$($event$$241$$) {
        $self$$95$$.$_handleTouchMove$($event$$241$$);
      };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.destroy = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$destroy$() {
    ...
    this.$_removeResizeListenerFunc$ && this.$_handleResizeFunc$ && (this.$_removeResizeListenerFunc$.call(this.$_callbackObj$, $elem$$25$$, this.$_handleResizeFunc$), this.$_removeResizeListenerFunc$.call(this.$_callbackObj$, this.$_contentContainer$, this.$_handleResizeFunc$));
    this.$_handleResizeFunc$ = null;
    $cbcClass$$1$$.$_reparentChildrenFromTable$(this.$_contentTableDiv$, $elem$$25$$);
    this.$_arContentElements$ = null;
    this.$_tableDiv$ ? $elem$$25$$.removeChild(this.$_tableDiv$) : ($elem$$25$$.removeChild(this.$_overflowContainer$), $elem$$25$$.removeChild(this.$_vertDivNextButton$), $elem$$25$$.removeChild(this.$_vertDivPrevButton$));
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_getElemInnerWidth$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$_getElemInnerWidth$$($computedStyle$$1_elem$$27$$) {
    var $cbcClass$$3$$ = $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$;
    $computedStyle$$1_elem$$27$$ = $cbcClass$$3$$.$_getComputedStyle$($computedStyle$$1_elem$$27$$);
    return $cbcClass$$3$$.$_getCSSLengthAsInt$($computedStyle$$1_elem$$27$$.width);
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_getElemInnerHeight$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$_getElemInnerHeight$$($computedStyle$$2_elem$$28$$) {
    var $cbcClass$$4$$ = $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$;
    $computedStyle$$2_elem$$28$$ = $cbcClass$$4$$.$_getComputedStyle$($computedStyle$$2_elem$$28$$);
    return $cbcClass$$4$$.$_getCSSLengthAsInt$($computedStyle$$2_elem$$28$$.height);
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_addBubbleEventListener$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$_addBubbleEventListener$$($node$$30$$, $type$$82$$, $listener$$36$$) {
    $node$$30$$.addEventListener ? $node$$30$$.addEventListener($type$$82$$, $listener$$36$$, !1) : $node$$30$$.attachEvent && $node$$30$$.attachEvent("on" + $type$$82$$, $listener$$36$$);
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_removeBubbleEventListener$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$_removeBubbleEventListener$$($node$$31$$, $type$$83$$, $listener$$37$$) {
    $node$$31$$.removeEventListener ? $node$$31$$.removeEventListener($type$$83$$, $listener$$37$$, !1) : $node$$31$$.detachEvent && $node$$31$$.detachEvent("on" + $type$$83$$, $listener$$37$$);
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_getWheelDelta$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$_getWheelDelta$$($event$$243$$) {
    var $wheelDelta$$ = 0;
    return $wheelDelta$$ = null != $event$$243$$.wheelDelta ? $event$$243$$.wheelDelta : null != $event$$243$$.deltaY ? -$event$$243$$.deltaY : -$event$$243$$.detail;
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_wrapAndRestrictSize$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$_wrapAndRestrictSize$$($elem$$29$$, $parentElem$$, $bWidth$$, $bHeight$$) {
    var $wrapperDiv$$ = document.createElement("div"), $wrapperDivStyle$$ = $wrapperDiv$$.style;
    $wrapperDivStyle$$.display = "inline-block";
    $wrapperDiv$$.appendChild($elem$$29$$);
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_createInnerContainers$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_createInnerContainers$$() {
    var $self$$96$$ = this, $bHoriz$$3_overflowHeight$$ = this.$_isHorizontal$(), $overflowContainer$$ = document.createElement("div");
    ...
    var $elem$$30$$ = this.$_elem$, $cbcClass$$6$$ = $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$, $contentContainer$$1_contentHeight$$ = document.createElement("div");
    ...
    if ($bHoriz$$3_overflowHeight$$) {
      ...
      var $i$$226_tableCellDivNextButtonStyle$$ = $numContentChildren_tableCellDivNextButton$$1$$.style;
      $arContentElements_tableCellDivPrevButton$$.style.verticalAlign = "top";
      $i$$226_tableCellDivNextButtonStyle$$.verticalAlign = "top";
    ...
    $arContentElements_tableCellDivPrevButton$$ = $cbcClass$$6$$.$_reparentChildrenToTable$($elem$$30$$, $contentTableDiv_tableRowDiv$$1_vertDivNextButton$$1$$, $bHoriz$$3_overflowHeight$$);
    if (this.$_contentParent$) {
      for ($arContentElements_tableCellDivPrevButton$$ = [], $contentChildren_tableCellDivOverflow$$ = this.$_contentParent$.children, $numContentChildren_tableCellDivNextButton$$1$$ = $contentChildren_tableCellDivOverflow$$.length, $i$$226_tableCellDivNextButtonStyle$$ = 0;$i$$226_tableCellDivNextButtonStyle$$ < $numContentChildren_tableCellDivNextButton$$1$$;$i$$226_tableCellDivNextButtonStyle$$++) {
        var $child$$7$$ = $contentChildren_tableCellDivOverflow$$[$i$$226_tableCellDivNextButtonStyle$$];
    ...
    $contentContainerStyle_tableDiv$$1_vertDivPrevButton$$ ? $elem$$30$$.appendChild($contentContainerStyle_tableDiv$$1_vertDivPrevButton$$) : (this.$_vertDivPrevButton$ = $contentContainerStyle_tableDiv$$1_vertDivPrevButton$$ = document.createElement("div"), this.$_vertDivNextButton$ = $contentTableDiv_tableRowDiv$$1_vertDivNextButton$$1$$ = document.createElement("div"), $elem$$30$$.appendChild($contentContainerStyle_tableDiv$$1_vertDivPrevButton$$), $elem$$30$$.appendChild($overflowContainer$$), 
    $elem$$30$$.appendChild($contentTableDiv_tableRowDiv$$1_vertDivNextButton$$1$$));
    ...
    $cbcClass$$6$$.$_addBubbleEventListener$($overflowContainer$$, "scroll", function($event$$244$$) {
      $self$$96$$.$_handleScroll$($event$$244$$);
    });
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_createPrevButton$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_createPrevButton$$($bHoriz$$4_buttonId$$, $buttonStyleClass_cbcClass$$7_prevButtonStyle$$1$$, $icon$$) {
    var $self$$97$$ = this, $prevButton$$1$$ = document.createElement("div");
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_createNextButton$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_createNextButton$$($bHoriz$$5_buttonId$$1$$, $buttonStyleClass$$1_cbcClass$$8_nextButtonStyle$$1$$, $icon$$1$$) {
    var $self$$98$$ = this, $nextButton$$2$$ = document.createElement("div");
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_measureContents$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_measureContents$$() {
    ...
    if (this.$_getContentParent$().hasChildNodes() && $bHoriz$$6_contentTableDiv$$1$$ && $arContentElements$$1$$ && 0 < $arContentElements$$1$$.length) {
      for (var $bHoriz$$6_contentTableDiv$$1$$ = this.$_isHorizontal$(), $contentWidth$$ = 0, $contentWidth$$ = this.$_contentContainer$.offsetWidth, $startOffset$$ = 0, $prevSizeObj$$ = null, $i$$227$$ = 0;$i$$227$$ < $arContentElements$$1$$.length;$i$$227$$++) {
        var $child$$8_childParent$$ = $arContentElements$$1$$[$i$$227$$];
        if (1 === $child$$8_childParent$$.nodeType) {
          ...
          if ($bHoriz$$6_contentTableDiv$$1$$) {
            ...
            0 === $i$$227$$ && ($startOffset$$ = $sizeObj$$1$$.start);
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_setOverflowMaxSize$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_setOverflowMaxSize$$($s$$6_size$$11$$) {
    var $overflowContainerStyle$$1$$ = this.$_overflowContainer$.style;
    $s$$6_size$$11$$ += "px";
    this.$_isHorizontal$() ? $overflowContainerStyle$$1$$.maxWidth = $s$$6_size$$11$$ : $overflowContainerStyle$$1$$.maxHeight = $s$$6_size$$11$$;
  };
    ...
    if (!this.$_isEmpty$()) {
      ...
      if ($bImmediate$$1$$ || !$scrollFunc$$ || $scroll$$5$$ === this.$_getCurrScroll$()) {
        ...
        $scrollFunc$$.call(this.$_callbackObj$, this.$_overflowContainer$, this.$_convertScrollLogicalToBrowser$($scroll$$5$$), Math.abs(this.$_getCurrScroll$() - $scroll$$5$$) / $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_SCROLL_SPEED$, function() {
          $self$$99$$.$_onScrollAnimEnd$($scroll$$5$$);
        });
      }
    }
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_handleMouseWheel$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_handleMouseWheel$$($event$$247$$) {
    var $bConsumeEvent$$ = this.$_bScrolling$;
    if (this.$_needsScroll$() && !this.$_bScrolling$) {
      var $wheelDelta$$1$$ = $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_getWheelDelta$($event$$247$$);
    ...
    $bConsumeEvent$$ && ($event$$247$$.preventDefault(), $event$$247$$.stopPropagation());
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_handleTouchStart$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_handleTouchStart$$($event$$248_eventTouches_firstTouch$$) {
    $event$$248_eventTouches_firstTouch$$ = $event$$248_eventTouches_firstTouch$$.touches;
    this.$_needsScroll$() && !this.$_bScrolling$ && 1 === $event$$248_eventTouches_firstTouch$$.length && (this.$_bTouch$ = !0, $event$$248_eventTouches_firstTouch$$ = $event$$248_eventTouches_firstTouch$$[0], this.$_touchStartCoord$ = this.$_isHorizontal$() ? $event$$248_eventTouches_firstTouch$$.pageX : $event$$248_eventTouches_firstTouch$$.pageY, this.$_touchStartScroll$ = this.$_getCurrScroll$(), this.$_touchStartNextScroll$ = this.$_calcNextScroll$(), this.$_touchStartPrevScroll$ = this.$_calcPrevScroll$());
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_handleTouchMove$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_handleTouchMove$$($diff_event$$249_firstTouch$$1$$) {
    if (this.$_bTouch$) {
      var $bHoriz$$7$$ = this.$_isHorizontal$();
      $diff_event$$249_firstTouch$$1$$ = $diff_event$$249_firstTouch$$1$$.touches[0];
      $diff_event$$249_firstTouch$$1$$ = ($bHoriz$$7$$ ? $diff_event$$249_firstTouch$$1$$.pageX : $diff_event$$249_firstTouch$$1$$.pageY) - this.$_touchStartCoord$;
      var $overflowContainer$$7$$ = this.$_overflowContainer$;
      Math.abs($diff_event$$249_firstTouch$$1$$) < $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.$_SWIPE_THRESHOLD$ * ($bHoriz$$7$$ ? $overflowContainer$$7$$.offsetWidth : $overflowContainer$$7$$.offsetHeight) ? this.$_setCurrScroll$(this.$_touchStartScroll$ - $diff_event$$249_firstTouch$$1$$, !0) : (this.$_setCurrScroll$(($bHoriz$$7$$ && this.$_bRtl$ ? 0 < $diff_event$$249_firstTouch$$1$$ : 0 > $diff_event$$249_firstTouch$$1$$) ? this.$_touchStartNextScroll$ : this.$_touchStartPrevScroll$), 
      this.$_bTouch$ = !1);
    }
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_setExternalScrollTimeout$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_setExternalScrollTimeout$$() {
    ...
    window.setTimeout(function() {
      $self$$100$$ && ($self$$100$$.$_bExternalScroll$ = !0);
    }, 0);
  };
  ...
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcStartScroll$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcStartScroll$$($index$$166$$) {
    return this.$_getSizes$()[$index$$166$$].start;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcEndScroll$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcEndScroll$$($index$$167$$) {
    return this.$_getSizes$()[$index$$167$$].end - this.$_getCurrViewportSize$() + 1;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcFirstVisibleItemIndex$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcFirstVisibleItemIndex$$() {
    var $i$$228$$ = this.$_calcItemIndex$(this.$_getCurrScroll$());
    return 0 > $i$$228$$ ? 0 : $i$$228$$;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcLastVisibleItemIndex$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcLastVisibleItemIndex$$() {
    var $i$$229$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() + this.$_getCurrViewportSize$() - 1), $sizes$$5$$ = this.$_getSizes$();
    return 0 > $i$$229$$ ? $sizes$$5$$.length - 1 : $i$$229$$;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcPrevVisibleItemIndex$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcPrevVisibleItemIndex$$() {
    var $i$$230$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() - 1);
    return 0 > $i$$230$$ ? 0 : $i$$230$$;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcNextVisibleItemIndex$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcNextVisibleItemIndex$$() {
    var $i$$231$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() + this.$_getCurrViewportSize$()), $sizes$$6$$ = this.$_getSizes$();
    return 0 > $i$$231$$ ? $sizes$$6$$.length - 1 : $i$$231$$;
  };
  $adf$$.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$.prototype.$_calcItemIndex$ = function $$adf$$$$shared$$$impl$$$conveyorBelt$$$ConveyorBeltCommon$$$$_calcItemIndex$$($scroll$$10$$) {
    for (var $sizes$$7$$ = this.$_getSizes$(), $i$$232$$ = 0;$i$$232$$ < $sizes$$7$$.length;$i$$232$$++) {
      if ($scroll$$10$$ <= $sizes$$7$$[$i$$232$$].end) {
        return $i$$232$$;
      }
    }
    return-1;
  ...
  (function() {
    $oj$$22$$.$__registerWidget$("oj.ojConveyorBelt", $$$$22$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{orientation:"horizontal", contentParent:null}, _ComponentCreate:function() {
      ...
      var $elem$$40_numChildren$$ = this.element, $i$$233_options$$289$$ = this.options;
      if ($children$$7_isInit$$ && !this.$_cbCommon$) {
        var $child$$9_orientation$$1$$ = $i$$233_options$$289$$.orientation, $callbackInfo$$1_prevStyleClass$$ = null, $nextStyleClass$$ = null, $prevIcon$$ = null, $nextIcon$$ = null, $animateScrollFunc_contentParentElem$$ = null;
        ...
        $i$$233_options$$289$$.contentParent && ($animateScrollFunc_contentParentElem$$ = $$$$22$$($i$$233_options$$289$$.contentParent)[0]);
        this.$_cbCommon$ = new window.adf.$shared$.$impl$.$conveyorBelt$.$ConveyorBeltCommon$($elem$$40_numChildren$$[0], $child$$9_orientation$$1$$, $animateScrollFunc_contentParentElem$$, this.$_bRTL$, $buttonInfo$$1$$, $callbackInfo$$1_prevStyleClass$$);
      }
      this.$_cbCommon$.$setup$($children$$7_isInit$$);
      if ($children$$7_isInit$$) {
        for ($children$$7_isInit$$ = $elem$$40_numChildren$$.find(".oj-conveyorbelt-overflow-indicator"), $elem$$40_numChildren$$ = $children$$7_isInit$$.size(), $i$$233_options$$289$$ = 0;$i$$233_options$$289$$ < $elem$$40_numChildren$$;$i$$233_options$$289$$++) {
          $child$$9_orientation$$1$$ = $children$$7_isInit$$.get($i$$233_options$$289$$), this.$_setupButtonMouseStyles$($child$$9_orientation$$1$$);
        }
      }
    }, _destroy:function() {
      ...
      this._super();
    }, _setOption:function($key$$82$$, $value$$190$$, $flags$$28$$) {
      var $bRecreate$$1$$ = !1;
      switch($key$$82$$) {
      ...
      this._super($key$$82$$, $value$$190$$, $flags$$28$$);
      $bRecreate$$1$$ && this.$_setup$(!0);
    }, $_destroyCBCommon$:function() {
      var $cbCommon$$1$$ = this.$_cbCommon$;
      $cbCommon$$1$$ && $cbCommon$$1$$.destroy();
      this.$_cbCommon$ = null;
    }, $_setupButtonMouseStyles$:function($element$$64$$) {
      this._on($element$$64$$, {mousedown:function($event$$252$$) {
        $$$$22$$($event$$252$$.currentTarget).addClass("oj-active");
      }, mouseup:function($event$$253$$) {
        $$$$22$$($event$$253$$.currentTarget).removeClass("oj-active");
      }, mouseenter:function($currTarget$$2_event$$254$$) {
        $currTarget$$2_event$$254$$ = $currTarget$$2_event$$254$$.currentTarget;
        $$$$22$$($currTarget$$2_event$$254$$).addClass("oj-hover");
        $$$$22$$($currTarget$$2_event$$254$$).removeClass("oj-default");
      }, mouseleave:function($currTarget$$3_event$$255$$) {
        $currTarget$$3_event$$255$$ = $currTarget$$3_event$$255$$.currentTarget;
        $$$$22$$($currTarget$$3_event$$255$$).removeClass("oj-hover");
        $$$$22$$($currTarget$$3_event$$255$$).removeClass("oj-active");
        $$$$22$$($currTarget$$3_event$$255$$).addClass("oj-default");
      }});
    }, $_createIcon$:function($iconStyleClass$$) {
      var $span$$ = document.createElement("span");
      $span$$.setAttribute("class", "oj-component-icon oj-clickable-icon " + $iconStyleClass$$);
      return $span$$;
    }, $_animateScrollLeft$:function($elem$$42$$, $value$$191$$, $duration$$11$$, $onEndFunc$$1$$) {
      var $props$$11$$ = {};
      $props$$11$$.scrollLeft = $value$$191$$;
      $$$$22$$($elem$$42$$).animate($props$$11$$, $duration$$11$$, "swing", $onEndFunc$$1$$);
    }, $_animateScrollTop$:function($elem$$43$$, $value$$192$$, $duration$$12$$, $onEndFunc$$2$$) {
      var $props$$12$$ = {};
      $props$$12$$.scrollTop = $value$$192$$;
      $$$$22$$($elem$$43$$).animate($props$$12$$, $duration$$12$$, "swing", $onEndFunc$$2$$);
    }, getNodeBySubId:function($locator$$15_subId$$12$$) {
      if (null == $locator$$15_subId$$12$$) {
        return this.element ? this.element[0] : null;
      }
      $locator$$15_subId$$12$$ = $locator$$15_subId$$12$$.subId;
      return "oj-conveyorbelt-start-overflow-indicator" === $locator$$15_subId$$12$$ ? this.widget().find(".oj-conveyorbelt-overflow-indicator.oj-start")[0] : "oj-conveyorbelt-end-overflow-indicator" === $locator$$15_subId$$12$$ ? this.widget().find(".oj-conveyorbelt-overflow-indicator.oj-end")[0] : "oj-conveyorbelt-top-overflow-indicator" === $locator$$15_subId$$12$$ ? this.widget().find(".oj-conveyorbelt-overflow-indicator.oj-top")[0] : "oj-conveyorbelt-bottom-overflow-indicator" === $locator$$15_subId$$12$$ ? 
