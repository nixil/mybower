...
define(["ojs/ojcore", "jquery"], function($oj$$2$$, $$$$2$$) {
  ...
  $oj$$2$$.$Message$.$getSeverityLevel$ = function $$oj$$2$$$$Message$$$getSeverityLevel$$($index$$66_severity$$2$$) {
    $index$$66_severity$$2$$ && ("string" === typeof $index$$66_severity$$2$$ ? ($index$$66_severity$$2$$ = $oj$$2$$.$Message$.$_LEVEL_TO_TYPE$.indexOf($index$$66_severity$$2$$, 1), $index$$66_severity$$2$$ = -1 === $index$$66_severity$$2$$ ? $oj$$2$$.$Message$.$SEVERITY_LEVEL$.ERROR : $index$$66_severity$$2$$) : "number" === typeof $index$$66_severity$$2$$ && $index$$66_severity$$2$$ < $oj$$2$$.$Message$.$SEVERITY_LEVEL$.CONFIRMATION && $index$$66_severity$$2$$ > $oj$$2$$.$Message$.$SEVERITY_LEVEL$.FATAL && 
    ($index$$66_severity$$2$$ = $oj$$2$$.$Message$.$SEVERITY_LEVEL$.ERROR));
    return $index$$66_severity$$2$$ ? $index$$66_severity$$2$$ : $oj$$2$$.$Message$.$SEVERITY_LEVEL$.ERROR;
  };
  ...
  $oj$$2$$.$Message$.$getSeverityType$ = function $$oj$$2$$$$Message$$$getSeverityType$$($level$$8$$) {
    var $index$$67$$;
    $level$$8$$ && ("string" === typeof $level$$8$$ ? ($index$$67$$ = $oj$$2$$.$Message$.$_LEVEL_TO_TYPE$.indexOf($level$$8$$, 1), -1 === $index$$67$$ && ($level$$8$$ = $oj$$2$$.$Message$.$SEVERITY_TYPE$.ERROR)) : "number" === typeof $level$$8$$ && ($level$$8$$ = $level$$8$$ < $oj$$2$$.$Message$.$SEVERITY_LEVEL$.CONFIRMATION && $level$$8$$ > $oj$$2$$.$Message$.$SEVERITY_LEVEL$.FATAL ? $oj$$2$$.$Message$.$SEVERITY_TYPE$.ERROR : $oj$$2$$.$Message$.$_LEVEL_TO_TYPE$[$level$$8$$]));
  ...
  $oj$$2$$.$Message$.$getMaxSeverity$ = function $$oj$$2$$$$Message$$$getMaxSeverity$$($messages$$) {
    ...
    $messages$$ && 0 < $messages$$.length && $$$$2$$.each($messages$$, function($i$$63$$, $message$$28$$) {
  ...
  $oj$$2$$.$ComponentMessage$ = function $$oj$$2$$$$ComponentMessage$$($summary$$2$$, $detail$$5$$, $severity$$3$$, $options$$99$$) {
    this.Init($summary$$2$$, $detail$$5$$, $severity$$3$$, $options$$99$$);
  };
  $oj$$2$$.$Object$.$createSubclass$($oj$$2$$.$ComponentMessage$, $oj$$2$$.$Message$, "oj.ComponentMessage");
  $oj$$2$$.$ComponentMessage$.$DISPLAY_TYPE$ = {$IMMEDIATE$:"immediate", $DEFERRED$:"deferred"};
  $oj$$2$$.$ComponentMessage$.$_DEFAULT_OPTIONS$ = {display:$oj$$2$$.$ComponentMessage$.$DISPLAY_TYPE$.$IMMEDIATE$, context:""};
  $oj$$2$$.$ComponentMessage$.prototype.Init = function $$oj$$2$$$$ComponentMessage$$$Init$($summary$$3$$, $detail$$6$$, $severity$$4$$, $options$$100$$) {
    $oj$$2$$.$ComponentMessage$.$superclass$.Init.call(this, $summary$$3$$, $detail$$6$$, $severity$$4$$);
    this.$_options$ = $$$$2$$.extend({}, $oj$$2$$.$ComponentMessage$.$_DEFAULT_OPTIONS$, $options$$100$$);
  };
  ...
  $oj$$2$$.$ComponentMessage$.prototype.$canDisplay$ = function $$oj$$2$$$$ComponentMessage$$$$canDisplay$$() {
    return!(this.$_options$ && this.$_options$.display && this.$_options$.display === $oj$$2$$.$ComponentMessage$.$DISPLAY_TYPE$.$DEFERRED$);
  };
  $oj$$2$$.$ComponentMessage$.prototype.$_forceDisplayImmediate$ = function $$oj$$2$$$$ComponentMessage$$$$_forceDisplayImmediate$$() {
    return this.$_options$ && $oj$$2$$.$ComponentMessage$.$DISPLAY_TYPE$.$DEFERRED$ === this.$_options$.display ? (this.$_options$.display = $oj$$2$$.$ComponentMessage$.$DISPLAY_TYPE$.$IMMEDIATE$, !0) : !1;
  };
});
