...
//a roosevelt's workaround for r.js failure of undefined ko
...
(function ( global, ko, jQuery, infuser, undefined ) {
	...
	var ExternalTemplateSource = function(templateId, options) {
	    ...
	    if(self.options && self.options.afterRender) {
            ...
            /* Mike Seminaro - modified the line below to fix the issue where afterRender was firing twice
               upon loading a new template. See https://github.com/ifandelse/Knockout.js-External-Template-Engine/issues/11
             */
